...
function product_comparison_woocommerce_activation_notice() {
	...
	echo '<p>'. esc_html__( 'Thank you for choosing Product Comparison Woocommerce. Would like to have you on our Welcome page so that you can reap all the benefits of our Product Comparison Woocommerce.', 'product-comparison-woocommerce' ) .'</p>';
	echo '<p><a href="'. esc_url( admin_url( 'themes.php?page=product_comparison_woocommerce_guide' ) ) .'" class="button button-primary">'. esc_html__( 'GET STARTED', 'product-comparison-woocommerce' ) .'</a></p>';
	echo '</div>';
}
...
define('WOOCOMMERCR_PRODUCT_COMPARISON_FREE_THEME_DOC',__('https://www.vwthemesdemo.com/docs/free-product-comparison-woocommerce/','product-comparison-woocommerce'));
define('WOOCOMMERCR_PRODUCT_COMPARISON_SUPPORT',__('https://wordpress.org/support/theme/product-comparison-woocommerce/','product-comparison-woocommerce'));
define('WOOCOMMERCR_PRODUCT_COMPARISON_REVIEW',__('https://wordpress.org/support/theme/product-comparison-woocommerce/reviews/','product-comparison-woocommerce'));
...
add_filter('loop_shop_columns', 'product_comparison_woocommerce_loop_columns');
	if (!function_exists('product_comparison_woocommerce_loop_columns')) {
		function product_comparison_woocommerce_loop_columns() {
...
function product_comparison_woocommerce_tagline_hide_show(){
	if(get_theme_mod('product_comparison_woocommerce_tagline_hide_show') == '1' ) {
		return true;
	}
	return false;
}
