    ...
    <div class="container">
    	<div class="footer-column">
	    	<?php
		        ...
		        if ( is_active_sidebar( 'estore-woocommerce-footer1' ) ) {
		            $count++;
		        }
		        if ( is_active_sidebar( 'estore-woocommerce-footer2' ) ) {
		            $count++;
		        }
		        if ( is_active_sidebar( 'estore-woocommerce-footer3' ) ) {
		            $count++;
		        }
		        // $count == 0 none
		        if ( $count == 1 ) {
      		...
      		?>
	      	<div class="row">
		        <div class="<?php if ( !is_active_sidebar( 'estore-woocommerce-footer1' ) ){ echo "footer_hide"; }else{ echo "$colmd"; } ?> col-xs-12 footer-block">
		          <?php dynamic_sidebar('estore-woocommerce-footer1'); ?>
		        </div>
		        <div class="<?php if ( is_active_sidebar( 'estore-woocommerce-footer2' ) ){ echo "$colmd"; }else{ echo "footer_hide"; } ?> col-xs-12 footer-block">
		            <?php dynamic_sidebar('estore-woocommerce-footer2'); ?>
		        </div>
		        <div class="<?php if ( is_active_sidebar( 'estore-woocommerce-footer3' ) ){ echo "$colmd"; }else{ echo "footer_hide"; } ?> col-xs-12 col-xs-12 footer-block">
		        ...
		        <div class="site-info col-lg-7 col-md-7 col-12">
		            <div class="footer-menu-left">
		            	<?php  if( ! get_theme_mod('estore_woocommerce_footer_text_setting') ){ ?>
						    ...
						    <span>
				          	 	<a target="_blank" href="<?php echo esc_url( 'https://www.themagnifico.net/themes/free-woocommerce-wordpress-theme/'); ?>">
					              <?php
