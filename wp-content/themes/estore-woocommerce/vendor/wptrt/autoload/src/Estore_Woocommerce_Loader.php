...
class Estore_Woocommerce_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function estore_woocommerce_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function estore_woocommerce_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function estore_woocommerce_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function estore_woocommerce_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->estore_woocommerce_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function estore_woocommerce_load( $class ) {
